...
Page({
  ...
  data: {
    ...
    apisecret : "qqUBXjBJzd6oGFMi8olYnGrUlNI7Hxok",
    apikey : "2TSelCPHfUJFoXnFSnbGNYS8"
  },
 ...
 */
  ...
  scanImageInfo: function (imageData) {
    var that = this;
    const detectUrl = `https://aip.baidubce.com/rest/2.0/image-classify/v1/image-understanding/get-result?access_token=${that.data.baiduToken}`;
